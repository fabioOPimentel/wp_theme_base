...
class EnfileirandoEstilos
{
    public function enfileirandoEstilo()
    {
        ...
        wp_enqueue_style('font-awesome', get_template_directory_uri() . '/node_modules/font-awesome/css/font-awesome.min.css', array(), null);
        wp_enqueue_style('slick', get_template_directory_uri() . '/node_modules/slick-carousel/slick/slick.css', array(), null);
        wp_enqueue_style('slick-theme', get_template_directory_uri() . '/node_modules/slick-carousel/slick/slick-theme.css', array(), null);
        wp_enqueue_style('Montserrat', "https://fonts.googleapis.com/css?family=Montserrat:400,500,700,900&display=swap", array(), null);
        wp_enqueue_style('template', get_template_directory_uri() . '/assets/css/template.css', array(), null);
        //Scripts
        ...
        wp_enqueue_script('jquery-nao-nativo', get_template_directory_uri() . '/node_modules/jquery/dist/jquery.js', array(), null, true);
        ...
        wp_enqueue_script('vue', get_template_directory_uri() . '/node_modules/vue/dist/vue.js', array(), null, true);
        wp_enqueue_script('vue-resource', get_template_directory_uri() . '/node_modules/vue-resource/dist/vue-resource.js', array(), null, true);
        wp_enqueue_script('lozad', get_template_directory_uri() . '/node_modules/lozad/dist/lozad.js', array(), null, true);
        wp_enqueue_script('slick', get_template_directory_uri() . '/node_modules/slick-carousel/slick/slick.js', array(), null, true);
